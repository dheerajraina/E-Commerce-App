...
class _HomePageState extends State<HomePage> {
  ...
  void initState(){
    ...
    toList(APIServices.instance.getCatalog());

   user= LoginPage.instance.username;
   pass=LoginPage.instance.password;
  login=LoginPage.instance.logged;
    // fetchCatalog();
    print("data $user");
  }
